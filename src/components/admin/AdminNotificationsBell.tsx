  ...
  return (
    <div ref={panelRef} className="relative">
      <button
        ...
        className="relative rounded-md border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-100"
      >
        Notifications
        {badgeText ? (
      ...
      {open ? (
        <div className="absolute right-0 z-40 mt-2 w-[380px] rounded-xl border border-slate-200 bg-white p-3 shadow-xl">
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-md border border-slate-300 px-2 py-1 text-[11px] font-medium text-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
              >
              ...
              {groupedItems.map((group) => (
                <div key={group.label} className="space-y-2">
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <article key={id || `${item.action}-${item.createdAt}`} className="rounded-lg border border-slate-200 p-2">
                        ...
                        <div className="mt-1 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="rounded-md border border-slate-300 px-2 py-0.5 text-[11px] font-medium text-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
                          >
          ...
          <div className="mt-3 flex justify-end">
            <Link href="/notifications" className="rounded-md bg-brand-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-brand-700">
              Open Full Center
            </Link>
          </div>
        </div>
